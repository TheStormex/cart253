class InstructionsState extends State {
  ...
  draw() {
    ...
    makeText("Fight!", width/2, height-height/4, width/5, width/30+height/30);
    ...
    fill(0);
    textAlign(CENTER,CENTER);
    makeText("You are a powerful wizard who can cast spells. A killer robot stands in your way with giant guns! Choose an ability in your inventory to use it. Click on green circles and avoid red ones. Control your vessel to dodge the bullets and collect the leaves. You will get another ability every turn. Blow up the robot with your magic! Good luck!", width/2, height/4, width-width/10, width/40+height/60);
